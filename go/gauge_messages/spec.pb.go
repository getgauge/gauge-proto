...
const (
	...
	Parameter_Multiline_String Parameter_ParameterType = 5 // A multiline string parameter, used for data driven execution.
)
...
type ProtoSuiteResult struct {
	...
	// / [DEPRECATED, use timestampISO] Timestamp of when execution started
	//
	// Deprecated: Marked as deprecated in spec.proto.
	...
	// / Screenshots captured on post hook exec time to be available on reports
	PostHookScreenshotFiles []string `protobuf:"bytes,22,rep,name=postHookScreenshotFiles,proto3" json:"postHookScreenshotFiles,omitempty"`
	// / RFC-3339 / ISO-8601 Timestamp of when execution started
	TimestampISO  string `protobuf:"bytes,23,opt,name=timestampISO,proto3" json:"timestampISO,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ProtoSuiteResult) GetTimestampISO() string {
	if x != nil {
...
type ProtoSpecResult struct {
	...
	// / [DEPRECATED, use timestampISO] Holds the timestamp of event starting.
	Timestamp string `protobuf:"bytes,11,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	// / RFC-3339 / ISO-8601 Timestamp of event starting.
	TimestampISO  string `protobuf:"bytes,12,opt,name=timestampISO,proto3" json:"timestampISO,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ProtoSpecResult) GetTimestampISO() string {
	if x != nil {
		return x.TimestampISO
	}
	return ""
...
type ProtoScenarioResult struct {
	...
	// / RFC-3339 / ISO-8601 Timestamp of event starting.
	TimestampISO  string `protobuf:"bytes,4,opt,name=timestampISO,proto3" json:"timestampISO,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ProtoScenarioResult) GetTimestampISO() string {
	if x != nil {
		return x.TimestampISO
	}
	return ""
...
func (x *ProtoStepResult) GetTimestampISO() string {
	if x != nil {
		return x.TimestampISO
	}
	return ""
...
const file_spec_proto_rawDesc = "" +
	...
	"\x05table\x18\x04 \x01(\v2\x1a.gauge.messages.ProtoTableR\x05table\"p\n" +
	"\rParameterType\x12\n" +
	"\n" +
	...
	"\x05Table\x10\x04\x12\x14\n" +
	"\x10Multiline_String\x10\x05\"\"\n" +
	...
	"\x15failureScreenshotFile\x18\x06 \x01(\tR\x15failureScreenshotFile\"\x87\b\n" +
	...
	"\ttimestamp\x18\v \x01(\tB\x02\x18\x01R\ttimestamp\x12,\n" +
	...
	"\x16preHookScreenshotFiles\x18\x15 \x03(\tR\x16preHookScreenshotFiles\x128\n" +
	"\x17postHookScreenshotFiles\x18\x16 \x03(\tR\x17postHookScreenshotFiles\x12\"\n" +
	"\ftimestampISO\x18\x17 \x01(\tR\ftimestampISO\"\x85\x04\n" +
	...
	"\ftimestampISO\x18\f \x01(\tR\ftimestampISO\"\xb6\x01\n" +
	...
	"\ftimestampISO\x18\x04 \x01(\tR\ftimestampISO\"\xb2\x01\n" +
	"\x0fProtoStepResult\x127\n" +
	"\tprotoItem\x18\x01 \x01(\v2\x19.gauge.messages.ProtoItemR\tprotoItem\x12$\n" +
	"\rexecutionTime\x18\x02 \x01(\x03R\rexecutionTime\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\tR\ttimestamp\x12\"\n" +
	"\ftimestampISO\x18\x04 \x01(\tR\ftimestampISO\"\xc6\x01\n" +
	"\x05Error\x123\n" +
